...
def how_many_before_collision(buckets, loops=1):
    '''
    roll random hash indexes into buckets and print how many rolls before a hash collision

    run loops number of times

    bucket is a collection of data ~~ deliberately unspecific
    ...
    for i in range(loops):
        ...
        while True:
            ...
            if hash_index not in tried:
                ...
                # found a collision
                break                                                                  # built in to get one decimal
